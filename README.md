...
### Example Output
```
(1/3) This is the transcription of the first 20-second chunk...
(2/3) Continuing with context from the previous chunk...
(3/3) Final chunk with complete narrative context...
```
